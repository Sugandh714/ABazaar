...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  TextEditingController phoneNumber = TextEditingController(text: '999999999');
  ...
  Widget build(BuildContext context) {
    Widget background = Container(
      decoration: BoxDecoration(
        image:
            DecorationImage(image: AssetImage('back.jpeg'), fit: BoxFit.cover),
      ),
      foregroundDecoration:
          BoxDecoration(color: Color.fromRGBO(240, 158, 6, 0.637)),
    );

    Widget title = Text(
      'Forgot your Password?',
      style: TextStyle(
          color: Color.fromARGB(255, 238, 103, 7),
          fontSize: 34.0,
          fontWeight: FontWeight.bold,
          shadows: [
            BoxShadow(
              color: Color.fromRGBO(210, 6, 6, 0.141),
              offset: Offset(0, 5),
              blurRadius: 10.0,
            )
          ]),
      ...
      child: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage('back.jpeg'), fit: BoxFit.cover)),
        child: Container(
