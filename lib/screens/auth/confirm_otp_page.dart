...
class _ConfirmOtpPageState extends State<ConfirmOtpPage> {
  ...
  Widget otpBox(TextEditingController otpController) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: Color.fromRGBO(216, 179, 179, 0.8),
  ...
  Widget build(BuildContext context) {
    Widget title = Text(
      'Confirm your OTP',
      style: TextStyle(
          color: Color.fromARGB(255, 143, 120, 45),
          fontSize: 34.0,
    ...
    Widget subTitle = Padding(
        ...
        child: Text(
          ...
          style: TextStyle(
            color: Color.fromARGB(255, 231, 185, 36),
            fontSize: 16.0,
          ),
        ));
      ...
      children: <Widget>[
        Text(
          ...
          style: TextStyle(
            ...
            color: Color.fromRGBO(251, 145, 6, 0.486),
            fontSize: 14.0,
          ),
        ),
        InkWell(
          ...
          child: Text(
            '0:39',
            style: TextStyle(
              color: Color.fromARGB(255, 246, 63, 63),
              fontWeight: FontWeight.bold,
              fontSize: 14.0,
            ),
          ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Scaffold(
            appBar: AppBar(
              backgroundColor: const Color.fromARGB(0, 228, 94, 94),
              elevation: 0.0,
            ),
            body: Stack(
              children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: PinCodeTextField(
                            ...
                            highlightColor: Color.fromARGB(194, 252, 203, 97),
                            highlightAnimation: true,
                            highlightAnimationBeginColor:
                                const Color.fromARGB(194, 252, 203, 97),
                            ...
                            defaultBorderColor:
                                const Color.fromARGB(194, 252, 203, 97),
                            pinBoxColor: Color.fromARGB(194, 252, 203, 97),
                            maxLength: 4,
                          ),
                        ),
                      ),
